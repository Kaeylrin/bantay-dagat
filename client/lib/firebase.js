...
// Session persistence: auth is cleared when the browser tab/window is closed
// This ensures auto-logout for security purposes
...
export {
  db, auth,
  ref, onValue, query, orderByChild, limitToLast, off, push, set, get, update, remove,
